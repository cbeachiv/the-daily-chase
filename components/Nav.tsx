...
const TABS = [
  ...
  { href: "/mood", label: "Mood", icon: "M12 21C6 16 3 12 3 8.5A4.5 4.5 0 0 1 12 6a4.5 4.5 0 0 1 9 2.5C21 12 18 16 12 21z" },
...
export default function Nav() {
  ...
  return (
    <>
      ...
      <nav className="pb-safe fixed inset-x-0 bottom-0 z-20 grid grid-cols-7 border-t border-line bg-card/95 backdrop-blur sm:hidden">
        {TABS.map((t) => {
          const active = pathname === t.href;
          return (
            <Link
